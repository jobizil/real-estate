...
def contact(request):
    if request.method=="POST":
        ...
        # 'There has been an inqury for ' + listing + '. Sign into admin panel for more information.',
        # 'quilltech57@gmail.com',
        # [realtor_email, 'ugbemjob57@gmail.com'],
        # fail_silently=False,
        # )
        messages.success(request, 'Your request has been submitted, we\'ll get back to you as soon as possible')
